...
void Kernel::Initialize()
{
    ...
    addrLock = new Semaphore("addrLock", 1);     // semaphore trong synch.h
    gPhysPageBitMap = new Bitmap(256); // quan ly cac frame vat ly tren ram
    pageTable = new Bitmap(10);       // Quan ly cac trang
    //parentIdTable;      // Quan ly cac tien trinh cha
    //fileNameTable;    // Quan ly ten cac tien trinh
    pTab = new PTable(10);
    sTab = new STable();
